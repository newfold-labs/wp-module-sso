# Agent guidance – wp-module-sso

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-sso** – Single sign-on functionality for Newfold WordPress sites. Registers with the Newfold Module Loader; depends on wp-module-data. Maintained by Newfold Labs.

- **Stack:** PHP 7.3+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; provides SSO flows. See docs/integration.md.
